...
<div {{ $attributes->merge(['class' => 'ui-alert ui-alert--' . $type]) }} role="alert">
    ...
    @if($dismissible)
        <button type="button" class="ui-alert__close" onclick="this.parentElement.remove()" aria-label="Tutup notifikasi">&times;</button>
    @endif
</div>
